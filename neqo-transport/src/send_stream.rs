    ...
    pub fn write_frames<B: Buffer>(
        ...
        if single_group_no_sendorder {
            ...
            'groups: for i in 0..num_groups {
                ...
                // Lowest priority in the group: reached only when no higher-sendOrder
                // stream had sendable data this pass.
...
mod tests {
    ...
    fn flow_control_blocked_stream_does_not_starve_sendorder_peer() {
        ...
        ss.set_sendgroup(blocked_high, Some(1)).unwrap();
        ...
        ss.set_sendgroup(low, Some(1)).unwrap();
        ...
        ss.set_sendgroup(other, Some(2)).unwrap();
